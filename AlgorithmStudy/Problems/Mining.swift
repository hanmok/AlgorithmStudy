    ...
    func solution(_ picks:[Int], _ minerals:[String]) -> Int {
        ...
        for (idx, mineral) in minerals.enumerated() {
            ...
            if idx % 5 != 0 {
                ...
                newMinerals[lastIdx] += fatigue
            } else {
                newMinerals.append(fatigue)
            }
        }
        ...
        for (mineralIdx, newMineral) in newMinerals.enumerated() {
            if mineralIdx != newMinerals.count - 1 {
                let numOfDias = newMineral / 25
                let numOfIrons = (newMineral - numOfDias * 25) / 5
                let numOfStones = newMineral - numOfDias * 25 - numOfIrons * 5
